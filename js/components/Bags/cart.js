    ...
    return (
      <Container>
        <Header style={{  backgroundColor: '#63254d' }} iosBarStyle="light-content">
          ...
          <Body>  
              <Title style={{color: "#fff", fontSize: responsiveFontSize(1.5),  fontWeight: '800'}} >SHOPPING CART</Title>
          </Body>
          <Right>
            <Button style={{borderColor: 'darkgray'}} small  bordered onPress={ () => Actions["bags_wishlist"]() } >
