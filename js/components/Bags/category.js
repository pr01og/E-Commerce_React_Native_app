  ...
  render() {
    ...
    return (
      <Container>
        ...
        <Header style={{ flexDirection: 'row', backgroundColor: '#63254d' }} androidStatusBarColor="#dc2015" iosBarStyle="light-content">
            <Left>
            ...
            <Body>
            <Title style={{color: "#fff", fontSize: responsiveFontSize(2)}}>{this.props.title}</Title>
          </Body>
