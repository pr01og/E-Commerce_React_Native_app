      ...
      if(this.state.landing){
        ...
        return (
          ...
          <Row size={2} style={{backgroundColor: "#f5f5f5"}}>
            ...
            <Col style={home_styles.landright}>
              <Image
                style={{marginTop: 60, width: width/2.4, height: height/7}}
                source={require("./mainComponent/images/forwatches.jpg")}
              />
              
              <Button transparent onPress={()=>Actions['watches']()} style={{width: responsiveWidth(50), alignSelf: 'center'}} >
                <Image  source={require('../../images/slider/3_button.png')} style={{width: responsiveWidth(30),  height: responsiveHeight(5), alignSelf: 'center'}}>
                </Image>
              </Button>
         ...
         <Row size={2} style={{ backgroundColor: "#f5f5f5", borderTopWidth: 2, borderTopColor: "#fff"}}>
            ...
            <Col style={home_styles.landright}>
              <Image
                style={{marginTop: 60, width: responsiveWidth(42), height: responsiveHeight(10)}}
                source={require("./mainComponent/images/forbags.jpg")}
              />
              <Button transparent onPress={()=>Actions['bags']({site: 'bags'})} style={{width: responsiveWidth(50), alignSelf: 'center'}} >
                <Image  source={require('../../images/slider/3_button.png')} style={{width: responsiveWidth(30),  height: responsiveHeight(5), alignSelf: 'center'}}>
                </Image>
              </Button>
