        ...
        <Header style={{backgroundColor: '#63254d'}} androidStatusBarColor="#dc2015" iosBarStyle="light-content">
          <Left>
            <Button transparent onPress={() => Actions.pop()}>
              <Icon style={{color: '#fff', fontWeight: '100'}} name="arrow-back" />
            </Button>
          </Left>
          <Right>
            <Button  transparent><Icon style={{color: '#fff'}} name="share" /></Button>
            <Button  transparent onPress={ () => Actions['bags_cart']()}><Icon style={{color: '#fff'}}  name="cart" />
            {
