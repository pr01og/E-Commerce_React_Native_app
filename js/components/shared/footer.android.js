        ...
        <Footer>
            <FooterTab style={{backgroundColor: '#f5f5f5' }}>
              <Button active={this.state.tab1}
                ...
                <Icon style={{fontSize: 20, color: "#000"}} active={this.state.tab1}
                      name="home"/>
                <Text style={{fontSize: 10, color: "#000"}}>Home</Text>
              </Button>
              <Button active={this.state.tab2}
                      onPress={() => Actions['header6']()}>
                <Icon style={{fontSize: 20, color: "#000"}} active={this.state.tab2}
                      name="ios-notifications-outline"/>
                <Text style={{fontSize: 10, color: "#000"}}>Notices</Text>
              </Button>
              <Button active={this.state.tab3}
                      onPress={() => Actions['header3']()}>
                <Icon style={{fontSize: 20}} active={this.state.tab3}
                      name="ios-person-outline"/>
                <Text style={{fontSize: 10, color: "#000"}}>Profile</Text>
              </Button>
              <Button active={this.state.tab4}
                      onPress={() => Actions['header7']()}>
                <Icon style={{fontSize: 20, color: "#000"}} active={this.state.tab4}
                      name="cart"/>
                <Text style={{fontSize: 10, color: "#000"}}>Cart</Text>
              </Button>
            </FooterTab>
          </Footer>
        )
